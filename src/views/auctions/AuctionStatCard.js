...
const StatCard = ({ stat, amount, loading, suffix, tooltip }) => {
            ...
            <div style={{ textAlign: 'center', padding: '1%' }}>           
                <div>
                    ...
                    {loading ? <CircularProgress size={23} /> : (
                        <Typography variant="subtitle1" color="secondary" style={{ fontWeight: '400' }}>{Number(amount).toLocaleString() ?? 0} {suffix}</Typography>
                    )}
