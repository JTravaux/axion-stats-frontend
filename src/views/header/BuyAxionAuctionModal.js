...
const BuyAxionAuctionModal = ({ isOpen, close, isDarkMode }) => {
    ...
    return (
        <Dialog open={isOpen} onClose={close} classes={{ paper: "accordianHues"}} scroll="body">
            ...
            <DialogContent>
                <Typography variant="subtitle1" color="textSecondary">By purchasing Axion from the daily auction using my referral link, you will get a <strong>10% bonus</strong>. Axion from the auction will be automatically staked for 14 days and you must manually claim it afterwards.</Typography>
                <br />
